		...
		<div className="row">
			<div className="col-md-6">
				...
				<div className="mb-2"><span>JavaScript</span>
					<div className="progress my-1">
						<div className="progress-bar bg-primary" role="progressbar" data-aos="zoom-in-right"
								 data-aos-delay="300" data-aos-anchor=".skills-section" style={{width: "55%"}} aria-valuenow="45"
								 aria-valuemin="0" aria-valuemax="100"/>
					</div>
				</div>
			</div>
			<div className="col-md-6">
				<div className="mb-2"><span>TypeScript</span>
					<div className="progress my-1">
						<div className="progress-bar bg-success" role="progressbar" data-aos="zoom-in-right"
								 data-aos-delay="400" data-aos-anchor=".skills-section" style={{width: "40%"}} aria-valuenow="30"
								 aria-valuemin="0" aria-valuemax="100"/>
					</div>
				</div>
				<div className="mb-2"><span>MySQl</span>
					<div className="progress my-1">
						<div className="progress-bar bg-success" role="progressbar" data-aos="zoom-in-right"
								 data-aos-delay="500" data-aos-anchor=".skills-section" style={{width: "75%"}} aria-valuenow="85"
								 aria-valuemin="0" aria-valuemax="100"/>
					</div>
				</div>
				<div className="mb-2"><span>Adobe Photoshop</span>
					<div className="progress my-1">
						<div className="progress-bar bg-success" role="progressbar" data-aos="zoom-in-right"
								 data-aos-delay="600" data-aos-anchor=".skills-section" style={{width: "65%"}} aria-valuenow="75"
								 aria-valuemin="0" aria-valuemax="100"/>
					</div>
				</div>
			</div>
